...
namespace SimaxCrm.Data.BaseRepository
{
        ...
        where T : class
    {
        ...
        public void UpdateEntity(T entity, bool hasTid = true)
        {
            if (hasTid)
            {
                mapTip(entity);
        ...
        {
            //if (_httpContextAccessor.HttpContext != null && _httpContextAccessor.HttpContext.User != null && _httpContextAccessor.HttpContext.User.Identity.IsAuthenticated)
            //{
            //    var objTid = _httpContextAccessor.HttpContext.User.Claims.Where(c => c.Type == "Tid").FirstOrDefault();
            //    if (objTid != null)
            //    {
